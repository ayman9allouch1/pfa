...
class DicomFileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DicomFile
        fields = ['id', 'title', 'description', 'series', 'series_id', 'image_url']
...
class ImageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Image
        fields = ['id', 'title', 'description', 'dicom_file', 'dicom_file_id', 'image_url', 'url_name']
...
class AnnotationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'file_name', 'file_size', 'region_count', 'region_id', 'region_shape_attributes_tool_name', 
            ...
            'region_attributes_comment', 'region_attributes_comment_value','image_id', 'image'
        ]